...
(function (global) {
  ...
  var TYPES = {
    ...
    standard: { label: 'عادية', w: 335, h: 155, rows: 2,
                ...
                bandStyle: 'tall', bandW: 0.22, bandSymbol: true },

    // الشعار في الوسط وتحته السعودية و KSA — لا شريط على اليمين
    long:     { label: 'طويلة', w: 520, h: 110, rows: 2,
                order: ['digits', 'band', 'letters'],
                weight: { digits: 1, letters: 1 },
                bandStyle: 'compact', bandW: 0.70, bandSymbol: true },

    // مثل الطويلة بحجمها: صفّ واحد لاتيني والشريط في الوسط
    sport:    { label: 'رياضية', w: 310, h: 110, rows: 1, script: 'la',
                order: ['digits', 'band', 'letters'],
                weight: { digits: 1, letters: 1 },
