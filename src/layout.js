...
(function (global) {
  ...
  var TYPES = {
    ...
    standard: { label: 'عادية', w: 335, h: 155, rows: 2,
                ...
                /* ——— الخانتان متساويتان ———
                 *
                 * في اللوحة الحقيقية خانةُ الأرقام أعرض: قيست صورتان
                 * مواجِهتان فوقع الفاصلُ الأوسط عند ٤٩٪ من العرض
                 * والشريطُ عند ٨٤٪ — فالأرقام ٤٩٪ والحروف ٣٥٪،
                 * نسبتُهما ١٫٣٨. فجُعلت كذلك.
                 *
                 * ثمّ رآها صاحبُ الأداة فقال: «مساحة الحروف والأرقام
                 * غير متساوية» — وهي شكواه الأولى في هذا المشروع.
                 * فردَّت إلى التساوي: هو شكلٌ يريده، والمنزلقُ يردُّ
                 * نسبةَ اللوحة الحقيقية لمن أرادها (١٫٣٨). */
